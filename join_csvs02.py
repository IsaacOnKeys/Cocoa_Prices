...
# Function to filter out records with any null values
def filter_nulls(element):
    return (
        element["cocoa_price_euro"] is not None
        and element["Brent_Price"] is not None
        and element["precipitation"] is not None
        and element["soil_moisture"] is not None
    )
...
def run():
    ...
    with beam.Pipeline(options=pipeline_options) as p:
        ...
        combined = (
            ...
            | "Filter Null Values" >> beam.Filter(filter_nulls)
